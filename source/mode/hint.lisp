...
(defun set-alignment (original-element element rect)
  "Set the alignment for the DOM element used as a hint."
...
(define-parenscript-async hint-elements (hints nyxt-identifiers)
  (defun create-hint-overlay (original-element hint)
    ...
    (ps:let ((user-y-offset (ps:lisp (hints-offset-y (find-submode 'hint-mode))))
      ...
      (ps:lisp (set-alignment original-element element rect))
      element))
